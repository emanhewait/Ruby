...
class Person
  ...
  class User < Person
    ...
    def create
        if !valid_name?
        puts "This Name Is Invalid."
        return false
        elsif !self.class.valid_mobile?(mobile)
        puts "This Phone Is Invalid"
        return false
        else
 ...
 puts "Please Enter Your Mobile Phone:"
 mobile = gets.chomp

 user = User.new(name, email, mobile)
 user.create
puts "Please Enter * To List Our User Or Number :"
input = gets.chomp
...
if input == "*"
  ...
  puts " This Is Invalid Data . Please enter '*' or number."
end